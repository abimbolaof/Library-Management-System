...
namespace LIBRARY
{
    public partial class Staff_Register : Form
    {
        ...
        private void Staff_Register_Load(object sender, EventArgs e)
        {
            if ((modify) && (modifyval != ""))
            {
            ...
            try
            {
                if (modify)
                {
                    ...
                    try
                    {
                        ...
                        com.Parameters.AddWithValue("@programme", "N/A");
                        com.Parameters.AddWithValue("@level", "N/A");
                        com.Parameters.AddWithValue("@roomNo", "N/A");
                        com.Parameters.AddWithValue("@hall", "N/A");
